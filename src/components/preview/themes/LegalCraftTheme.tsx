...
import { Phone, Mail, MapPin, Clock, Globe, Linkedin, Scale, BookOpen, PenTool as Pen, Gavel, UserCheck, MessageCircle, Wallet, Menu, GraduationCap, Briefcase } from 'lucide-react';
