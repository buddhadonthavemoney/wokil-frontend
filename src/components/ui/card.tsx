...
const cardVariants = cva("rounded-xl border border-border bg-card text-card-foreground shadow-sm", {
  variants: {
    variant: {
      default: "",
      // Stitch's hover card — anything clickable (a site row, a source result).
      interactive: "transition-shadow hover:shadow-md",
      // Recessed panel nested inside another card; no shadow of its own.
      flat: "shadow-none bg-surface-low",
    },
  },
  defaultVariants: {
    variant: "default",
